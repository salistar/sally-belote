/**
 * BeloteEngine - Moteur de jeu Belote marocain
 ...
 *   est rompue par un "Belote!" (contestation) ou quand tout le monde passe
 *   sans contester (alors le joueur suivant peut recommencer avec une nouvelle
 *   valeur — cela clôt la séquence précédente).
 * - N'importe quel autre joueur peut crier "Belote!" pour contester
...
export type GamePhase =
  ...
  | 'challenging'  // Fenêtre de contestation "Belote!"
...
export function gameReducer(state: GameState, action: GameAction): GameState {
  switch (action.type) {
    ...
    case 'PLAY_CARD': {
      ...
      // poser une carte (= renoncer à crier Belote) OU appuyer sur Belote.
      ...
      // Seule une contestation Belote! ou un nouveau round peut rompre la
