...
> Belote française classique 4 joueurs — vs bots ou en ligne.

[![Build APK](https://github.com/salistar/sally-belote/actions/workflows/android-build.yml/badge.svg)](https://github.com/salistar/sally-belote/actions/workflows/android-build.yml)
[![Lint & Test](https://github.com/salistar/sally-belote/actions/workflows/lint-and-test.yml/badge.svg)](https://github.com/salistar/sally-belote/actions/workflows/lint-and-test.yml)

App mobile faisant partie de la suite **SallyCards** — Expo SDK 52, React Native 0.76, Hermes, expo-router.

| | |
|---|---|
| **Bundle ID Android** | `com.sallycards.belote` |
| **Bundle ID iOS** | `com.sallycards.belote` |
...
- Belote classique + Coinche (3 modes : 4 joueurs en équipe)
- Multi-joueur en ligne via Socket.IO + WebRTC voice chat (TURN)
- Mode VsBot 1-3 IA, niveau facile / normal / dur
- Annonces (belote, rebelote, capot, dernière levée)
- Calcul automatique des plis, tableau scores en temps réel
- 5 langues + RTL Arabe
...
```powershell
git clone https://github.com/salistar/sally-belote.git
cd sally-belote
npm install
npx expo start
...
subst Y: C:\Users\$env:USERNAME\Desktop\sally-belote
cd Y:\
...
# Install + launch
adb uninstall com.sallycards.belote 2>$null
adb install -r app\build\outputs\apk\debug\app-debug.apk
adb shell am start -n com.sallycards.belote/.MainActivity
...
keytool -genkeypair -v -storetype PKCS12 `
  -keystore belote.keystore -alias belote `
  -keyalg RSA -keysize 2048 -validity 10000

# 2) Configurer android/gradle.properties
@"
BELOTE_UPLOAD_STORE_FILE=belote.keystore
BELOTE_UPLOAD_KEY_ALIAS=belote
BELOTE_UPLOAD_STORE_PASSWORD=<password>
BELOTE_UPLOAD_KEY_PASSWORD=<password>
