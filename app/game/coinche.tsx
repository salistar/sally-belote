...
const s = StyleSheet.create({
  ...
  contractGrid: { marginTop: 6 },
  contractLabel: {
    color: '#FCD34D', fontSize: 13, fontWeight: '900', marginBottom: 6,
    letterSpacing: 0.4,
  },
  suitBtn: {
    ...
    borderWidth: 1, borderColor: 'rgba(96, 165, 250, 0.55)',
  },
  suitBtnText: { color: '#93C5FD', fontSize: 15, fontWeight: '900', letterSpacing: 0.5 },
  passBtn: {
  ...
  passBtnText: { color: '#FCA5A5', fontSize: 14, fontWeight: '900', letterSpacing: 0.5 },
